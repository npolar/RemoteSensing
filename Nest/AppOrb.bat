...
REM Ending E1 Ers1, E2 ERS2, old format open VDF_DAT.001, N1 -- ASAR APP
 for /r S:\CryoClimValidation\Kongsfjorden\NestImported %%X in (*.dim) do (gpt C:\Users\max\Documents\PythonProjects\Nest\AppOrb.xml -Pfile="%%X"  -Tfile="S:\CryoClimValidation\Kongsfjorden\AppOrb\%%~nX_AppOrb.dim")
