...
REM Ending E1 Ers1, E2 ERS2, old format open VDF_DAT.001, N1 -- ASAR APP
 ...
 for /r C:\Users\max\Documents\Svalbard\CryoClimValidation\SouthSpitsbergen\AppOrb %%X in (*.dim) do (gpt C:\Users\max\Documents\Svalbard\CryoClimValidation\Calib_Spk_TC_LinDB.xml -Pfile="%%X"  -Tfile="C:\Users\max\Documents\Svalbard\CryoClimValidation\SouthSpitsbergen\AppOrb_Calib_Spk_TC_LinDB\%%~nX_Calib_Spk_TC_LinDB.dim")
