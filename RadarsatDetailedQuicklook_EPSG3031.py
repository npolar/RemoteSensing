...
#filelist = glob.glob(r'Z:\Radarsat\2013\temp\*.zip') 
filelist = glob.glob(r'Z:\Radarsat\2013\RS2_201305*.zip') 
...
for radarsatfile in filelist:
    ...
    outputfilename = infilepath + '\\' + infileshortname + '\\' + infileshortname + '_EPSG3031.tif'
