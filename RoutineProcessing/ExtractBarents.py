...
def CheckLocationPoint(radarsatfile, point):
    ...
    #writes to textfile list of corrput zip files
    try:
...
#      
    ...
    point_EPSG3575_x = point[0]
    point_EPSG3575_y = point[1]
...
#    AreaOfInterest_lowerright_EPSG4326_x, AreaOfInterest_lowerright_EPSG4326_y =pyproj.transform(EPSG32633, EPSG4326, AreaOfInterest_lowerright_EPSG32633_x, AreaOfInterest_lowerright_EPSG32633_y)
    point_EPSG4326_x, point_EPSG4326_y = pyproj.transform(EPSG3575, EPSG4326, point_EPSG3575_x, point_EPSG3575_y)
    ...
    if (RS2_upperleftEPSG4326_x < point_EPSG4326_x < RS2_lowerrightEPSG4326_x):
        
        if (RS2_upperleftEPSG4326_y > point_EPSG4326_y > RS2_lowerrightEPSG4326_y):
            contained = True   
...
#      
    ...
    AreaOfInterest_upperleft_EPSG3575_x = location[0]
    AreaOfInterest_upperleft_EPSG3575_y = location[1]
    AreaOfInterest_lowerright_EPSG3575_x = location[2]
    AreaOfInterest_lowerright_EPSG3575_y = location[3]
...
#    AreaOfInterest_upperleft_EPSG4326_x, AreaOfInterest_upperleft_EPSG4326_y = pyproj.transform(EPSG32633, EPSG4326, AreaOfInterest_upperleft_EPSG32633_x, AreaOfInterest_upperleft_EPSG32633_y)
#    AreaOfInterest_lowerright_EPSG4326_x, AreaOfInterest_lowerright_EPSG4326_y =pyproj.transform(EPSG32633, EPSG4326, AreaOfInterest_lowerright_EPSG32633_x, AreaOfInterest_lowerright_EPSG32633_y)
    AreaOfInterest_upperleft_EPSG4326_x, AreaOfInterest_upperleft_EPSG4326_y = pyproj.transform(EPSG3575, EPSG4326, AreaOfInterest_upperleft_EPSG3575_x, AreaOfInterest_upperleft_EPSG3575_y)
    AreaOfInterest_lowerright_EPSG4326_x, AreaOfInterest_lowerright_EPSG4326_y =pyproj.transform(EPSG3575, EPSG4326, AreaOfInterest_lowerright_EPSG3575_x, AreaOfInterest_lowerright_EPSG3575_y)
     
    
    #Check if two points are contained in image
    contained = False
    
    #print coordinates just to see if it makes sense
...
def ProcessNest(radarsatfile, outputfilepath, location):
    ...
    for envifile in dimlist:
        ...
        if location != []:
            ...
            if radarsatfileshortname[0:2] == 'S1': 
                #target resolution is set to 50m instead original 25 to decrease file size                
...
#Define Area Of Interest EPSG3575(???))
...
#Lance N-ICE
#upperleft_x = 487923.364
#upperleft_y = 9272330.965
#lowerright_x = 747072.088
#lowerright_y = 9030937.686

#FramStrait
upperleft_x = -398065.586 
upperleft_y = -840393.684
lowerright_x = -85734.611 
lowerright_y = -1223370.951
point_x = -258632.115
point_y = -1035600.543
...
for radarsatfile in filelist:
    ...
    if location != []:
        ...
        print 
        contained = CheckLocationPoint(radarsatfile, point)
