...
#Fimbulisen
upperleft_x = -12035.0
upperleft_y =  2237207.0       
lowerright_x = 56953.0        
lowerright_y = 2139193.0
...
inputfolder = "//mnt//satellittdata//Radarsat//Flerbruksavtale//Antarctica//2009"
#inputfolder = "//mnt//max//JitterTest"
outputfolder = "//mnt//glaciology//processedSARimages//Fimbulisen_50_meter//2009"
...
for root, dirnames, filenames in os.walk(inputfolder):
    for filename in fnmatch.filter(filenames, '*2009*.zip'):
